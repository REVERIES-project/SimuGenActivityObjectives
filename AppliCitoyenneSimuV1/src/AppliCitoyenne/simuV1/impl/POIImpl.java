 ...
 * </p>
 * <ul>
 *   <li>{@link AppliCitoyenne.simuV1.impl.POIImpl#getY <em>Y</em>}</li>
 *   <li>{@link AppliCitoyenne.simuV1.impl.POIImpl#getX <em>X</em>}</li>
 * </ul>
 *
 * @generated
 */
public class POIImpl extends MinimalEObjectImpl.Container implements POI {
	...
	public void setY(int newY) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimuV1Package.POI__Y, oldY, y));
	}
	...
	public void setX(int newX) {
		...
		x = newX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimuV1Package.POI__X, oldX, x));
	}
