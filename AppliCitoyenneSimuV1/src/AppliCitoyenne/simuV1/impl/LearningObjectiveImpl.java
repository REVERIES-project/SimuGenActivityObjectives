 ...
 * </p>
 * <ul>
 *   <li>{@link AppliCitoyenne.simuV1.impl.LearningObjectiveImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LearningObjectiveImpl extends MinimalEObjectImpl.Container implements LearningObjective {
	...
	protected EClass eStaticClass() {
		return SimuV1Package.Literals.LEARNING_OBJECTIVE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimuV1Package.LEARNING_OBJECTIVE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SimuV1Package.LEARNING_OBJECTIVE__NAME:
				return getName();
		}
