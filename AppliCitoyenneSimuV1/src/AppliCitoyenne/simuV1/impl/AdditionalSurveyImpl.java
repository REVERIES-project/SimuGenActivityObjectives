...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Additional Survey</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link AppliCitoyenne.simuV1.impl.AdditionalSurveyImpl#getBasicsurvey <em>Basicsurvey</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdditionalSurveyImpl extends BotanicalSurveyImpl implements AdditionalSurvey {
	/**
	 ...
	 * @generated
	 */
	protected AdditionalSurveyImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SimuV1Package.Literals.ADDITIONAL_SURVEY;
	}
		...
		if (basicsurvey != null && basicsurvey.eIsProxy()) {
			...
			if (basicsurvey != oldBasicsurvey) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimuV1Package.ADDITIONAL_SURVEY__BASICSURVEY, oldBasicsurvey, basicsurvey));
			}
		}
		return basicsurvey;
	}
	...
	public NotificationChain basicSetBasicsurvey(BasicSurvey newBasicsurvey, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SimuV1Package.ADDITIONAL_SURVEY__BASICSURVEY, oldBasicsurvey, newBasicsurvey);
	...
	public void setBasicsurvey(BasicSurvey newBasicsurvey) {
		if (newBasicsurvey != basicsurvey) {
			...
			if (basicsurvey != null)
				msgs = ((InternalEObject)basicsurvey).eInverseRemove(this, SimuV1Package.BASIC_SURVEY__ADDITIONALSURVEY, BasicSurvey.class, msgs);
			if (newBasicsurvey != null)
				msgs = ((InternalEObject)newBasicsurvey).eInverseAdd(this, SimuV1Package.BASIC_SURVEY__ADDITIONALSURVEY, BasicSurvey.class, msgs);
			msgs = basicSetBasicsurvey(newBasicsurvey, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimuV1Package.ADDITIONAL_SURVEY__BASICSURVEY, newBasicsurvey, newBasicsurvey));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SimuV1Package.ADDITIONAL_SURVEY__BASICSURVEY:
				if (basicsurvey != null)
					msgs = ((InternalEObject)basicsurvey).eInverseRemove(this, SimuV1Package.BASIC_SURVEY__ADDITIONALSURVEY, BasicSurvey.class, msgs);
